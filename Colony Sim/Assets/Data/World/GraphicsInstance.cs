...
namespace ColonySim
{
	...
	public class GraphicInstance
	{
		...
		)
		{
			...
			this.material = new Material(ResourceManager.LoadEntityMaterial(def.materialName));
		...
		)
		{
			...
			Texture2D _texture = (texture == null) ? ResourceManager.LoadEntityTexture(def.textureName) : texture;
